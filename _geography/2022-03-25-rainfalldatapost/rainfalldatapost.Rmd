...
## Downloading files
In this lesson, you will need the .Rmd script and the .csv file which contains the data. Download the zip file above and save the zip folder on your desktop (or anywhere on your computer). 

To unzip the files:

- On windows, you can right click on the zip folder and select "extract all"
- On a mac double click on the folder 

Then, open the folder and open up the R Project file (this looks like a blue R cube). This will automatically open up Rstudio and all of the files will be loaded in. To start working through the lesson, simply open up the `rainfall_data.Rmd` file. 
...
- I can view my data in a new R window 

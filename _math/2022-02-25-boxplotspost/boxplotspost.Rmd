...
preview: testphoto.png
---

`r xfun::embed_file(here::here("_math", "2022-02-25-boxplotspost", "boxplots.Rmd"), text = "Download .Rmd here")`

`r xfun::embed_file(here::here("_math", "2022-02-25-boxplotspost", "boxplots.docx"), text = "Download word document here")`

`r xfun::embed_file(here::here("_math", "2022-02-25-boxplotspost", "boxplots.docx"), text = "Download pdf here")`

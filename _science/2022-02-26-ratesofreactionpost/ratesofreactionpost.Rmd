...
`r xfun::embed_file(here::here("_science", "2022-02-26-ratesofreaction", "rates_of_reaction.Rmd"), text = "Download .Rmd here")`

`r xfun::embed_file(here::here("_science", "2022-02-26-ratesofreaction", "rates_of_reaction.docx"), text = "Download word document here")`

`r xfun::embed_file(here::here("_science", "2022-02-26-ratesofreaction", "rates_of_reaction.docx"), text = "Download pdf here")`

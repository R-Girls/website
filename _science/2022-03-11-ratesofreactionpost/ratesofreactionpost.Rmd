...
description: |
  The lesson starts with a worked example to introduce the R code needed to draw a graph of the mean time for the cross to disappear against the concentratrion of sodium thiosulphate and then allows the student to reproduce the graph using their own data
# author: []
date: 2022-03-11
output:
...
`r xfun::embed_file(here::here("_science", "2022-03-11-ratesofreactionpost", "rates_of_reaction.Rmd"), text = "Download .Rmd here")`

`r xfun::embed_file(here::here("_science", "2022-03-11-ratesofreactionpost", "rates_of_reaction.docx"), text = "Download word document here")`

`r xfun::embed_file(here::here("_science", "2022-03-11-ratesofreactionpost", "rates_of_reaction.pdf"), text = "Download pdf here")`
</div>

...
`r xfun::embed_file(here::here("_R", "2022-02-26-markdown1post", "markdown1.Rmd"), text = "Download .Rmd here")`

`r xfun::embed_file(here::here("_R", "2022-02-26-markdown1post", "markdown1.docx"), text = "Download word document here")`

`r xfun::embed_file(here::here("_R", "2022-02-26-markdown1post", "markdown1.docx"), text = "Download pdf here")`
</div>

<div style="text-align: center">

<img src="feedback_first_markdown2.jpg" width="600px" min-width="300px" max-width="300px" />
